            ...
            <template slot-scope="scope">
              <div :style="scope.row.milepostRow.milepostActive == 1 || scope.row.milepostRow.milepostActive == 2 ? Style: Style1">
                <el-steps :active="scope.row.milepostRow.milepostActive" >
                  <el-step v-for="(value, index) in scope.row.milepostRow.milepost"
                           :key="index"
                           v-if="index<scope.row.milepostRow.milepostActive+1"
                           v-show="index+1==scope.row.milepostRow.milepostActive ||
                                  index+1 == scope.row.milepostRow.milepostActive-1 ||
                                  index+1==scope.row.milepostRow.milepostActive+1"
                           :class="scope.row.milepostRow.milepostActive== index+1 ? scope.row.milepostRow.stepActive: '' "
                           :title="value.title"
                  >
                  </el-step>
                </el-steps>
